#' String left
#' @description Create a new string of text to the left of sep
#'
#' @param x a character vector
#' @param sep a separator character (defaults to "_", don't use backslash)
#' @details use to separate a string into just the part to left of a delimiter such as "-" or "_", also see st_right
#' @examples
